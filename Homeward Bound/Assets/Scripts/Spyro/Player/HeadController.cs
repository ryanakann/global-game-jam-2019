...
namespace AroundTheBend {
    ...
    public class HeadController : MonoBehaviour {
        ...
        private Vector3 headLookVector = Vector3.forward;
        private Vector3 headUpVector = Vector3.up;
        ...
        void Start () {
            ...
            if(defaultTarget == null) {
                defaultTarget = new GameObject("Default Look Location");
                defaultTarget.transform.SetParent(rootNode);
                defaultTarget.transform.position = rootNode.position + 1 * headLookVector.normalized;
            }
            targetObj = defaultTarget;
        ...
        void LateUpdate () {
            ...
            foreach (BendingSegment segment in segments) {
                ...
                Vector3 lookDirWorld = (TargetPos - segment.lastTransform.position).normalized;
